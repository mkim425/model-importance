...
```{r NAavg-table}
df_all_scores_extended_NAavg <- readRDS(paste0(basepath,"/main-data/df_all_scores_extended_NAavg.rds"))
...
# pdf(file=paste0(basepath,"/main-Rcode/plot-relationship-NAavg.pdf"), 
#     width = 10,
#     height = 5)
# p.pairs.NAavg
# dev.off()
...
# pdf(file=paste0(basepath,"/main-Rcode/plot-relationship-NAdrop.pdf"), 
#     width = 10,
#     height = 5)
# p.pairs.NAdrop
# dev.off()
