...
# write.csv(truth_data, file = paste0(base_path,"truth_MA_2021.csv"))
...
# write.csv(forecasts_MA_2021, paste0(base_path,"forecasts_MA_2021_hor1-4.csv"), row.names = FALSE)
```
...
# write.csv(fdat.ma.2021all,paste0(base_path,"fdat.ma.2021all.csv"), row.names = FALSE)
```
...
# write.csv(df.all.ma.2021, paste0(base_path,"forecast_ma2021_full.csv"), row.names = FALSE)


## ----- Save the file as RDS after modifying the column names -----

# forecast_ma2021_full <- read_csv(paste0(base_path,"forecast_ma2021_full.csv"))
# original_cols <- colnames(forecast_ma2021_full)
# colnames(forecast_ma2021_full)[7:29] <- paste("X" ,original_cols[7:29],sep="")
# saveRDS(forecast_ma2021_full, paste0(base_path,"forecast_death_ma2021.rds"))
```
